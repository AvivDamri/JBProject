...
public class SportControllerTest implements CommandLineRunner {
    ...
    private static final String URL = "http://localhost:8080/sport/items/";
...
//    private BaseAST Base64Utility;
    ...
    public void run(String... args) {
        ...
        System.out.print(AppArtUtils.ROUND_6 + "Sport");
        ...
        ResponseEntity<Item> response = restTemplate.exchange(URL+3, HttpMethod.GET, entity, Item.class);
        Item body = restTemplate.exchange(URL+3, HttpMethod.GET, entity, Item.class).getBody();
        ...
        Item toUpdate = restTemplate.exchange(URL+3, HttpMethod.GET, entity, Item.class).getBody();
        toUpdate.setName("Messi");
